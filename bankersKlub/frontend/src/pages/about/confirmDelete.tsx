 ...
 * @property {() => void} handleDeleteAbout - Function to handle the delete action.
 */
interface ConfirmDeleteDialogProps {
  open: boolean;
  handleClose: () => void;
...
/**
 * ConfirmDeleteDialog component used to confirm the deletion of a about.
 *
 * Displays a dialog asking the user to confirm if they really want to delete the about.
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      ...
      <DialogActions>
        ...
        <MotionButton onClick={handleDeleteAbout}>Delete</MotionButton>
      </DialogActions>
    </Dialog>
  );
};
