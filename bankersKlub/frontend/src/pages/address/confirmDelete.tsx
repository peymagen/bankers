 ...
 * @property {() => void} handleDeleteAddress - Function to handle the delete action.
 */
interface ConfirmDeleteDialogProps {
  open: boolean;
  handleClose: () => void;
...
/**
 * ConfirmDeleteDialog component used to confirm the deletion of a address.
 *
 * Displays a dialog asking the user to confirm if they really want to delete the address.
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      ...
      <DialogActions>
        ...
        <MotionButton onClick={handleDeleteAddress}>Delete</MotionButton>
      </DialogActions>
    </Dialog>
  );
};
