 ...
 * @property {() => void} handleDeleteAdvantage - Function to handle the delete action.
 */
interface ConfirmDeleteDialogProps {
  open: boolean;
  handleClose: () => void;
  handleDeleteAdvantage: () => void;
}

/**
 * ConfirmDeleteDialog component used to confirm the deletion of a advantage.
 *
 * Displays a dialog asking the user to confirm if they really want to delete the advantage.
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      ...
      <DialogActions>
        ...
        <MotionButton onClick={handleDeleteAdvantage}>Delete</MotionButton>
      </DialogActions>
    </Dialog>
  );
};
