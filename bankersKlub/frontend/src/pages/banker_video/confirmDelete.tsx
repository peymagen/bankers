 ...
 * @property {() => void} handleDeleteBankerVideo - Function to handle the delete action.
 */
interface ConfirmDeleteDialogProps {
  open: boolean;
  handleClose: () => void;
  handleDeleteBankerVideo: () => void;
}

/**
 * ConfirmDeleteDialog component used to confirm the deletion of a bankerVideo.
 *
 * Displays a dialog asking the user to confirm if they really want to delete the bankerVideo.
...
const ConfirmDeleteDialog: React.FC<ConfirmDeleteDialogProps> = ({
  open,
  handleClose,
  handleDeleteBankerVideo,
}) => {
  return (
    <Dialog open={open} onClose={handleClose}>
      <DialogTitle>Confirm Delete</DialogTitle>
      <DialogContent>
        Are you sure, you want to delete this bankerVideo?
      </DialogContent>
      <DialogActions>
        <Button onClick={handleClose}>Cancel</Button>
        <MotionButton onClick={handleDeleteBankerVideo}>Delete</MotionButton>
      </DialogActions>
    </Dialog>
  );
};
