 ...
 * @property {() => void} handleDeleteBlog - Function to handle the delete action.
 */
interface ConfirmDeleteDialogProps {
  open: boolean;
  handleClose: () => void;
...
/**
 * ConfirmDeleteDialog component used to confirm the deletion of a blog.
 *
 * Displays a dialog asking the user to confirm if they really want to delete the blog.
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      ...
      <DialogActions>
        ...
        <MotionButton onClick={handleDeleteBlog}>Delete</MotionButton>
      </DialogActions>
    </Dialog>
  );
};
