 ...
 * @property {() => void} handleDeleteCategory - Function to handle the delete action.
 */
interface ConfirmDeleteDialogProps {
  open: boolean;
  handleClose: () => void;
...
/**
 * ConfirmDeleteDialog component used to confirm the deletion of a category.
 *
 * Displays a dialog asking the user to confirm if they really want to delete the category.
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      ...
      <DialogActions>
        ...
        <MotionButton onClick={handleDeleteCategory}>Delete</MotionButton>
      </DialogActions>
    </Dialog>
  );
};
