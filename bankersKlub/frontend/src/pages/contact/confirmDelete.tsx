 ...
 * @property {() => void} handleDeleteContact - Function to handle the delete action.
 */
interface ConfirmDeleteDialogProps {
  open: boolean;
  handleClose: () => void;
...
/**
 * ConfirmDeleteDialog component used to confirm the deletion of a contact.
 *
 * Displays a dialog asking the user to confirm if they really want to delete the contact.
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      ...
      <DialogActions>
        ...
        <MotionButton onClick={handleDeleteContact}>Delete</MotionButton>
      </DialogActions>
    </Dialog>
  );
};
