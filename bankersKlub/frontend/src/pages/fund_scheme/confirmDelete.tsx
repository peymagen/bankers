 ...
 * @property {() => void} handleDeleteFundScheme - Function to handle the delete action.
 */
interface ConfirmDeleteDialogProps {
  open: boolean;
  handleClose: () => void;
  handleDeleteFundScheme: () => void;
}

/**
 * ConfirmDeleteDialog component used to confirm the deletion of a fundScheme.
 *
 * Displays a dialog asking the user to confirm if they really want to delete the fundScheme.
...
const ConfirmDeleteDialog: React.FC<ConfirmDeleteDialogProps> = ({
  open,
  handleClose,
  handleDeleteFundScheme,
}) => {
  return (
    <Dialog open={open} onClose={handleClose}>
      <DialogTitle>Confirm Delete</DialogTitle>
      <DialogContent>
        Are you sure, you want to delete this fundScheme?
      </DialogContent>
      <DialogActions>
        <Button onClick={handleClose}>Cancel</Button>
        <MotionButton onClick={handleDeleteFundScheme}>Delete</MotionButton>
      </DialogActions>
    </Dialog>
  );
};
