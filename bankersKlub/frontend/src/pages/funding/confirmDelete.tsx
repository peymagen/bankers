 ...
 * @property {() => void} handleDeleteFunding - Function to handle the delete action.
 */
interface ConfirmDeleteDialogProps {
  open: boolean;
  handleClose: () => void;
  handleDeleteFunding: () => void;
}

/**
 * ConfirmDeleteDialog component used to confirm the deletion of a funding.
 *
 * Displays a dialog asking the user to confirm if they really want to delete the funding.
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      ...
      <DialogActions>
        ...
        <MotionButton onClick={handleDeleteFunding}>Delete</MotionButton>
      </DialogActions>
    </Dialog>
  );
};
