 ...
 * @property {() => void} handleDeleteHome - Function to handle the delete action.
 */
interface ConfirmDeleteDialogProps {
  open: boolean;
  handleClose: () => void;
  handleDeleteHome: () => void;
}

/**
 * ConfirmDeleteDialog component used to confirm the deletion of a home.
 *
 * Displays a dialog asking the user to confirm if they really want to delete the home.
...
const ConfirmDeleteDialog: React.FC<ConfirmDeleteDialogProps> = ({
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      ...
      <DialogContent>Are you sure, you want to delete this home?</DialogContent>
      <DialogActions>
        <Button onClick={handleClose}>Cancel</Button>
        <MotionButton onClick={handleDeleteHome}>Delete</MotionButton>
      </DialogActions>
    </Dialog>
  );
};
