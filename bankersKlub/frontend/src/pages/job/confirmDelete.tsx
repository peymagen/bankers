 ...
 * @property {() => void} handleDeleteJob - Function to handle the delete action.
 */
interface ConfirmDeleteDialogProps {
  open: boolean;
  handleClose: () => void;
...
/**
 * ConfirmDeleteDialog component used to confirm the deletion of a job.
 *
 * Displays a dialog asking the user to confirm if they really want to delete the job.
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      ...
      <DialogActions>
        ...
        <MotionButton onClick={handleDeleteJob}>Delete</MotionButton>
      </DialogActions>
    </Dialog>
  );
};
