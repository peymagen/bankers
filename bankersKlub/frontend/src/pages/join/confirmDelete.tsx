 ...
 * @property {() => void} handleDeleteJoin - Function to handle the delete action.
 */
interface ConfirmDeleteDialogProps {
  open: boolean;
  handleClose: () => void;
  handleDeleteJoin: () => void;
}

/**
 * ConfirmDeleteDialog component used to confirm the deletion of a join.
 *
 * Displays a dialog asking the user to confirm if they really want to delete the join.
...
const ConfirmDeleteDialog: React.FC<ConfirmDeleteDialogProps> = ({
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      ...
      <DialogContent>Are you sure, you want to delete this join?</DialogContent>
      <DialogActions>
        <Button onClick={handleClose}>Cancel</Button>
        <MotionButton onClick={handleDeleteJoin}>Delete</MotionButton>
      </DialogActions>
    </Dialog>
  );
};
