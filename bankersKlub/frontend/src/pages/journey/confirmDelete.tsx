 ...
 * @property {() => void} handleDeleteJourney - Function to handle the delete action.
 */
interface ConfirmDeleteDialogProps {
  open: boolean;
  handleClose: () => void;
...
/**
 * ConfirmDeleteDialog component used to confirm the deletion of a journey.
 *
 * Displays a dialog asking the user to confirm if they really want to delete the journey.
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      ...
      <DialogActions>
        ...
        <MotionButton onClick={handleDeleteJourney}>Delete</MotionButton>
      </DialogActions>
    </Dialog>
  );
};
