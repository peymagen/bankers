 ...
 * @property {() => void} handleDeletePageInfo - Function to handle the delete action.
 */
interface ConfirmDeleteDialogProps {
  open: boolean;
  handleClose: () => void;
  handleDeletePageInfo: () => void;
}

/**
 * ConfirmDeleteDialog component used to confirm the deletion of a pageInfo.
 *
 * Displays a dialog asking the user to confirm if they really want to delete the pageInfo.
...
const ConfirmDeleteDialog: React.FC<ConfirmDeleteDialogProps> = ({
  open,
  handleClose,
  handleDeletePageInfo,
}) => {
  return (
    <Dialog open={open} onClose={handleClose}>
      <DialogTitle>Confirm Delete</DialogTitle>
      <DialogContent>
        Are you sure, you want to delete this pageInfo?
      </DialogContent>
      <DialogActions>
        <Button onClick={handleClose}>Cancel</Button>
        <MotionButton onClick={handleDeletePageInfo}>Delete</MotionButton>
      </DialogActions>
    </Dialog>
  );
};
