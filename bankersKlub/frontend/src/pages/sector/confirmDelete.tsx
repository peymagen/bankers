 ...
 * @property {() => void} handleDeleteSector - Function to handle the delete action.
 */
interface ConfirmDeleteDialogProps {
  open: boolean;
  handleClose: () => void;
  handleDeleteSector: () => void;
}

/**
 * ConfirmDeleteDialog component used to confirm the deletion of a sector.
 *
 * Displays a dialog asking the user to confirm if they really want to delete the sector.
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      ...
      <DialogActions>
        ...
        <MotionButton onClick={handleDeleteSector}>Delete</MotionButton>
      </DialogActions>
    </Dialog>
  );
};
