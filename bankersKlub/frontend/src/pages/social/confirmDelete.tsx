 ...
 * @property {() => void} handleDeleteSocial - Function to handle the delete action.
 */
interface ConfirmDeleteDialogProps {
  open: boolean;
  handleClose: () => void;
  handleDeleteSocial: () => void;
}

/**
 * ConfirmDeleteDialog component used to confirm the deletion of a social.
 *
 * Displays a dialog asking the user to confirm if they really want to delete the social.
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      ...
      <DialogActions>
        ...
        <MotionButton onClick={handleDeleteSocial}>Delete</MotionButton>
      </DialogActions>
    </Dialog>
  );
};
