 ...
 * @property {() => void} handleDeleteTestimonial - Function to handle the delete action.
 */
interface ConfirmDeleteDialogProps {
  open: boolean;
  handleClose: () => void;
  handleDeleteTestimonial: () => void;
}

/**
 * ConfirmDeleteDialog component used to confirm the deletion of a testimonial.
 *
 * Displays a dialog asking the user to confirm if they really want to delete the testimonial.
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      ...
      <DialogActions>
        ...
        <MotionButton onClick={handleDeleteTestimonial}>Delete</MotionButton>
      </DialogActions>
    </Dialog>
  );
};
