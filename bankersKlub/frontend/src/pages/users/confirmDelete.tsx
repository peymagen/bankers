 ...
 * @property {() => void} handleDeleteUser - Function to handle the delete action.
 */
interface ConfirmDeleteDialogProps {
  open: boolean;
  handleClose: () => void;
...
/**
 * ConfirmDeleteDialog component used to confirm the deletion of a user.
 *
 * Displays a dialog asking the user to confirm if they really want to delete the user.
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      ...
      <DialogActions>
        ...
        <MotionButton onClick={handleDeleteUser}>Delete</MotionButton>
      </DialogActions>
    </Dialog>
  );
};
