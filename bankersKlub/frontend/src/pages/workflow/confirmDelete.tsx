 ...
 * @property {() => void} handleDeleteWorkflow - Function to handle the delete action.
 */
interface ConfirmDeleteDialogProps {
  open: boolean;
  handleClose: () => void;
...
/**
 * ConfirmDeleteDialog component used to confirm the deletion of a workflow.
 *
 * Displays a dialog asking the user to confirm if they really want to delete the workflow.
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      ...
      <DialogActions>
        ...
        <MotionButton onClick={handleDeleteWorkflow}>Delete</MotionButton>
      </DialogActions>
    </Dialog>
  );
};
